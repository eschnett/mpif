module mpi_functions
  ...
  subroutine MPI_Type_create_darray_c( &
    ...
    integer :: rank
    integer :: ndims
    integer(MPI_COUNT_KIND) :: array_of_gsizes(*)
    integer :: array_of_distribs(*)
    integer :: array_of_dargs(*)
    integer :: array_of_psizes(*)
    integer :: order
  ...
  subroutine MPI_Type_create_hindexed_c( &
    ...
    implicit none
    integer(MPI_COUNT_KIND) :: count
    integer(MPI_COUNT_KIND) :: array_of_blocklengths(*)
    integer(MPI_COUNT_KIND) :: array_of_displacements(*)
    integer :: oldtype
    integer :: newtype
    integer :: ierror
  ...
  subroutine MPI_Type_create_subarray_c( &
    ...
    implicit none
    integer :: ndims
    integer(MPI_COUNT_KIND) :: array_of_sizes(*)
    integer(MPI_COUNT_KIND) :: array_of_subsizes(*)
    integer(MPI_COUNT_KIND) :: array_of_starts(*)
    integer :: order
    integer :: oldtype
    integer :: newtype
    integer :: ierror
  ...
  subroutine MPI_Type_get_contents_c( &
    ...
    integer :: array_of_integers(*)
    integer(MPI_ADDRESS_KIND) :: array_of_addresses(*)
    integer(MPI_COUNT_KIND) :: array_of_large_counts(*)
    integer :: array_of_datatypes(*)
    integer :: ierror
