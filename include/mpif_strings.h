...
// Find the first non-empty string in an array of strings. The array size is
// unknown.
size_t mpif_fcount(const char *strarr, size_t str_length);

// Find the first non-empty string in a 2d array of strings. The outer array
// size is unknown.
size_t mpif_fcount2d(const char *strarr, size_t strarr_size,
                     size_t strarr_index, size_t str_length);
