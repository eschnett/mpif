...
!     Window
      ...
      double precision MPI_Wtick, PMPI_Wtick
      external MPI_Wtime, PMPI_Wtime
      double precision MPI_Wtime, PMPI_Wtime

      external MPI_Aint_add, PMPI_Aint_add
      integer(MPI_ADDRESS_KIND) MPI_Aint_add, PMPI_Aint_add
      external MPI_Aint_diff, PMPI_Aint_diff
      integer(MPI_ADDRESS_KIND) MPI_Aint_diff, PMPI_Aint_diff
